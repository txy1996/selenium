...
/**
 * 
 * @ClassName: packageCustomertest 
 * @Description: TODO(测试客户管理) 
 * @author pjx
 * @date 2020年4月2日 下午2:15:25 
 *
 */
public class packageCustomertest {
    ...
    run();
	 ...
	 public static void run() {
	        Logger logger =Logger.getLogger(packageCustomertest.class);
	        //读取配置文件 (预设账号)
	        String excelFileName ="C:\\Users\\Akashi\\Desktop\\UserAccountContracttVO.xlsx";
...
//	        }
        ...
        //	        使用账号登录
	        ...
	        try {
	            ...
	            //返回流程事项名称
	            String processName = packageCustomer.packageCustomerPositioningExpenses(driver);
	            try {
	                Thread.sleep(2000);
	            }
	            catch (InterruptedException e) {
